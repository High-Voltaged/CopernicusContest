         ...
         <div class="article-content flex flex-col items-center lg:flex-row lg:items-start lg:justify-center p-5 sm:px-12 md:px-20 2xl:px-32">
            ...
            <div class="flex flex-col items-center w-full lg:w-3/5 2xl:w-2/5 relative lg:mr-10 -mt-88 lg:-mt-48 z-10">
               ...
               <div class="article-content__img flex-0 lg:absolute shadow-lg overflow-hidden mb-6">
                  ...
                  <div class="inline-flex w-full h-full relative bg-gray-tertiary bg-opacity-75 hover:bg-opacity-100 transition duration-200 ease cursor-pointer">

                        <img ref="img" :src="article.picture_link" class="object-cover" />
               ...
               <div class="bg-gray-main p-5 xl:p-10 rounded-md shadow-lg flex flex-col items-center relative w-full">
