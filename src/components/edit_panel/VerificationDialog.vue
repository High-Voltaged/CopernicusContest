<template>
   ...
   <div class="dialog-main_container fixed inset-0 bg-black bg-opacity-50 flex justify-center h-full w-full overflow-y-auto overflow-x-hidden z-50">

      <div class="dialog-content flex flex-col items-center relative w-19/20 sm:w-9/10 md:w-4/5 lg:w-2/3 xl:w-1/2 m-auto space-y-6 p-6 lg:p-8 bg-gray-main shadow-xl" style="border-radius: 15px">
