       ...
       get container() {
        ...
        timeline = [
            ...
            },
            {
                ...
                date: new Date('20 października 1497'),
            },
            {
