<template>
   ...
   <div class="read-more-container w-full xl:w-9/20 max-w-full xl:max-w-1/2 mx-4 my-8 lg:m-4">
      ...
      <div :class="{ 'justify-between': picture_right }" class="flex flex-col lg:flex-row items-center lg:items-end lg:min-h-56 xl:h-88">
         ...
         <div :class="{ 'lg:order-2': picture_right }" class="read-more-image flex-0 w-full sm:w-2/3 lg:w-40 2xl:w-48 h-80 lg:h-56 xl:h-72 shadow-md overflow-hidden lg:-mb-2 xl:-mb-8 z-10 lg:transition lg:duration-300 lg:ease-in" style="border-radius: 10px">
      ...
      <div :class="{ 'lg:justify-start': picture_right }" class="rounded-md bg-gray-400 -mx-2 mt-4 p-2 flex items-center justify-end w-full">
         ...
         <button class="arrow-container flex items-center px-3 py-2 hover:opacity-75 transition duration-300 linear focus:outline-none" style="border-radius: 10px">
