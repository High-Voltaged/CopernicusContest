<template>
   ...
   <div class="w-full px-2 md:px-4">
      ...
      <span class="block text-center text-4xl lg:text-5xl capitalize font-semibold leading-tight text-gray-200">
         {{ content.title }}
      </span>

      <div v-if="divider" class="divider relative h-px my-5 min-w-full">
      ...
      <span v-if="content.paragraph" class="inline-block w-full text-center font-light text-gray-300">
         {{ content.paragraph }}
      </span>
...
<script lang="ts">
   ...
   export default class MainTitle extends Vue {
      ...
      @Prop({ default: true }) private divider?: boolean;
