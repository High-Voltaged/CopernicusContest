<template>
   ...
   <div class="select-menu relative w-48">
      ...
      <div class="w-full">
         ...
         <div class="flex items-center space-x-2 bg-gray-primary p-3" style="border-radius: 10px 10px 0 0">
            ...
            <input 
               ...
               class="flex-auto w-full bg-transparent text-sm text-white placeholder-gray-300 focus:outline-none"
            />
      ...
      <transition name="fade-out">
         ...
         <div v-if="dropdownOn" class="select-menu__dropdown top-full absolute w-48 p-3 bg-gray-secondary" style="border-radius: 0 0 15px 15px">

            <button 
               v-for="c in categories"
               :key="c.id"
               :disabled="current == c"
               class="select-menu__cion inline-flex items-center w-full p-2 bg-gray-secondary hover:bg-gray-tertiary transition duration-300 ease focus:outline-none" 
